...
public class StaffMember {
    ...
    /**
     * Constructs a StaffMember object with the specified parameters.
     *
     * @param id               The ID of the staff member
     * @param firstName        The first name of the staff member
     * @param lastName         The last name of the staff member
     * @param role             The role of the staff member
     * @param hoursToWork      The hours the staff member is scheduled to work
     * @param totalHoursWorked The total hours worked by the staff member
     */
